...
import os
os.chdir('KocPython2019/13.NeuralNets')
...
tt = pd.read_csv('../12.GaussianProcesses/immSurvey.csv')
tt.head()
...
#play around with number of layers, layer sizes, different activations, etc. see if you can do better
