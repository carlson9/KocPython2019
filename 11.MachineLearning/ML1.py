...
model.coef_
model.intercept_
#interpreting model parameters is more a statistical modeling question than a machine learning question
#prediction
...
#Feature engineering
#one of the more important steps in using machine learning in practice is feature engineerin;—that is, taking whatever information you have about your problem and turning it into numbers that you can use to build your feature matrix
