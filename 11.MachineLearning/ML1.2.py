...
import pandas as pd
#read in data
counts = pd.read_csv('KocPython2019/11.MachineLearning/FremontHourly.csv', index_col='Date', parse_dates=True)
weather = pd.read_csv('KocPython2019/11.MachineLearning/SeaTacWeather.csv', index_col='DATE', parse_dates=True)
